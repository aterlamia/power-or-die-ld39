  ...
  public static Building createBuilding(BuildType buildType, ResourcesManager resourcesManager) {
    ...
    switch (buildType) {
      ...
      case BuildType.PowerPlant:
        building = new PowerBuilding("Plant1", BuildType.PowerPlant, 0.05f, 0f, 200f, 0, resourcesManager);
        break;
      case BuildType.Mine:
      ...
      default:
        building = new Building("CityHall", BuildType.CityCenter, 0f, 0.01f, 100f, 0f, resourcesManager);
        break;
    }
